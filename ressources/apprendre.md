...
Dans BattleFight, chaque personne joue avec son propre deck. Ton deck représente les techniques de combat que ton personnage peut utiliser. 
...
Tout le monde commence avec [20 points de vie](https://jejeu.org/outil.php?id=4&prereglage=pv) et aucune carte en main. Si ton adversaire tombe à zéro point de vie ou que tu le pousses hors du plateau, tu gagnes la partie.

### Jouer son tour

La partie se déroule au tour par tour. À ton tour tu joues une seule technique. 

Ça peut être une carte que tu joues depuis ta main ou une technique de base. 
