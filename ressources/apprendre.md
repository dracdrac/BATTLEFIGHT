...
Un tour consiste à jouer une technique : soit une des 5 **techniques de base** ou soit **une carte**. L'usage est de toujours annoncer à voix haute la technique que tu joues.
