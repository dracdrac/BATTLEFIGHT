...
title: Fiche de test
layout: print
description: Une fiche à faire remplir pendant les playtest
excerpt: Fiche à donner aux gens qui veulent pour nous permettre de tirer le meilleur des sessions de test.
width: 210mm
height: 297mm
bleed: 0mm
---
...
# Fiche de test BattleFight

Merci d'avoir joué, merci ×2 si tu prends le temps de remplir ça nous aide beaucoup !

**Tous les champs sont facultatifs, la fiche elle-même est facultative !**
...
Tu joue à des jeux : {% include jauge.html from="Jamais" to="Beaucoup" %}

Tu joue à des jeux de ce style (TCG) : {% include jauge.html from="Jamais" to="Beaucoup" %}
...
Tu as trouvé la mise en page des cartes : {% include jauge.html from="Lisible" to="Obscure" %}
...
La carte qui t'a le plus blasé :
